...
<html lang="es">
  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="#" onclick="Salir();">Cerrar sesión</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered"><script>document.write(window.sessionStorage.getItem("Usuario_Alias"));</script></h5>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <?php
                          // Se cargan los equipos que tenga el usuario
                          $loEquipo = new Equipo();
                          $loEquipo::CrearBotones($_SESSION['userid']);
                        ?>
                        <li><a href="javascript:NuevoEquipo_Mostrar(this);">Nuevo Equipo</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  <div id="DivCuerpo" class="col-lg-9 main-chart">
      ...
      *********************************************************************************************************************************************************** -->                  
                  ...
                  <div id="DivLateral" class="col-lg-3 ds">
